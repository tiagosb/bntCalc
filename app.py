...
display.grid(row=0, column=0, columnspan=4, sticky="wens", padx=4, pady=4)

btn7.grid(row=1, column=0, sticky="wens")
btn8.grid(row=1, column=1, sticky="wens")
btn9.grid(row=1, column=2, sticky="wens")
btnDivisao.grid(row=1, column=3, sticky="wens")

btn4.grid(row=2, column=0, sticky="wens")
btn5.grid(row=2, column=1, sticky="wens")
btn6.grid(row=2, column=2, sticky="wens")
btnMenos.grid(row=2, column=3, sticky="wens")

btn1.grid(row=3, column=0, sticky="wens")
btn2.grid(row=3, column=1, sticky="wens")
btn3.grid(row=3, column=2, sticky="wens")
btnVezes.grid(row=3, column=3, sticky="wens")

btn0.grid(row=4, column=0, sticky="wens")
btnPonto.grid(row=4, column=1, sticky="wens")
btnMais.grid(row=4, column=3, sticky="wens")
btnIgual.grid(row=4, column=2, sticky="wens")
